...
_LEAF_FOLDER_RULES: tuple[tuple[re.Pattern[str], str], ...] = (
    ...
    (re.compile(r"^mapicon\d+$", re.IGNORECASE), "mapIcon"),
    (re.compile(r"^map\d+$", re.IGNORECASE), "map"),
    (re.compile(r"^ddsmap\d+$", re.IGNORECASE), "ddsMap"),
    (re.compile(r"^ddsbanner\d+$", re.IGNORECASE), "ddsBanner"),
    ...
    (re.compile(r"^systemvoice\d+$", re.IGNORECASE), "systemVoice"),
    (re.compile(r"^charaworks\d+$", re.IGNORECASE), "charaWorks"),
    (re.compile(r"^skill\d+$", re.IGNORECASE), "skill"),
    (re.compile(r"^skillcategory\d+$", re.IGNORECASE), "skillCategory"),
    (re.compile(r"^musicgenre\d+$", re.IGNORECASE), "musicGenre"),
    (re.compile(r"^musiclabel\d+$", re.IGNORECASE), "musicLabel"),
    (re.compile(r"^releasetag\d+$", re.IGNORECASE), "releaseTag"),
    (re.compile(r"^netopen\d+$", re.IGNORECASE), "netOpen"),
    (re.compile(r"^gauge\d+$", re.IGNORECASE), "gauge"),
    (re.compile(r"^timetable\d+$", re.IGNORECASE), "timeTable"),
    (re.compile(r"^notesfieldline\d+$", re.IGNORECASE), "notesFieldLine"),
    (re.compile(r"^ticket\d+$", re.IGNORECASE), "ticket"),
    (re.compile(r"^avataraccessory\d+$", re.IGNORECASE), "avatarAccessory"),
)
